...
if (isset($languageService) && method_exists($languageService, 'readPluginModule')) {
...
<?php if (!empty($serverID)): ?>
  ...
  <div id="fallback-discord" class="alert alert-info text-center mt-3"<?= $discordDeclined ? '' : ' style="display:none;"' ?>>
